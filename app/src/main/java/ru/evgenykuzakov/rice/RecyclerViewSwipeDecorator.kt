...
class RecyclerViewSwipeDecorator private constructor() {
    ...
    private var mSwipeRightTypeface: Typeface = Typeface.SANS_SERIF

    private var mSwipeLeftCornerRadius = 0f
    private var mSwipeRightCornerRadius = 0f

    /**
     * Adding margin for swipe background
     */
    private var mSwipeLeftBackgroundMargin: IntArray
    private var mSwipeRightBackgroundMargin: IntArray
    ...
    init {
        ...
        mSwipeLeftBackgroundMargin = intArrayOf(0, 0, 0, 0)
        mSwipeRightBackgroundMargin = intArrayOf(0, 0, 0, 0)
    }
    ...
    /**
     * Set the margin of the background in the given unit (default is 0dp) when swipe right
     * @param unit TypedValue
     ...
     */
    fun setSwipeRightBackgroundMargin(unit: Int, left: Float, top: Float, right: Float, bottom: Float) {
        this.mSwipeRightBackgroundMargin = intArrayOf(
            TypedValue.applyDimension(unit, left, recyclerView!!.context.resources.displayMetrics).toInt(),
            TypedValue.applyDimension(unit, top, recyclerView!!.context.resources.displayMetrics).toInt(),
            TypedValue.applyDimension(unit, -right, recyclerView!!.context.resources.displayMetrics).toInt(),
            TypedValue.applyDimension(unit, -bottom, recyclerView!!.context.resources.displayMetrics).toInt())

    }

    /**
     * Set the margin of the background in the given unit (default is 0dp) when swipe left
     * @param unit TypedValue
     * @param left the left margin value
     * @param top the top margin value
     * @param right the right margin value
     * @param bottom the bottom margin value
     */
    fun setSwipeLeftBackgroundMargin(unit: Int, left: Float, top: Float, right: Float, bottom: Float) {
        this.mSwipeLeftBackgroundMargin = intArrayOf(
            TypedValue.applyDimension(unit, left, recyclerView!!.context.resources.displayMetrics).toInt(),
            TypedValue.applyDimension(unit, top, recyclerView!!.context.resources.displayMetrics).toInt(),
            TypedValue.applyDimension(unit, -right, recyclerView!!.context.resources.displayMetrics).toInt(),
            TypedValue.applyDimension(unit, -bottom, recyclerView!!.context.resources.displayMetrics).toInt())
     ...
     */
    /**
     * I added a modification that allows you to change the margin
     * and makes all the edges of the background rounded
     * (previously only the right edges or only the left were rounded
    ...
    fun decorate() {
        try {
            ...
            if (dX > 0) {
                // Swiping Right
                canvas!!.clipRect(
                    viewHolder!!.itemView.left + mSwipeRightBackgroundMargin[0],
                    viewHolder!!.itemView.top + mSwipeRightBackgroundMargin[1],
                    viewHolder!!.itemView.left + dX.toInt() + mSwipeRightBackgroundMargin[2],
                    viewHolder!!.itemView.bottom + mSwipeRightBackgroundMargin[3]
                )
                if (swipeRightBackgroundColor != 0) {
                    if (mSwipeRightCornerRadius != 0f) {
                        ...
                        background.setBounds(
                            viewHolder!!.itemView.left + mSwipeRightPadding[1] + mSwipeRightBackgroundMargin[0],
                            viewHolder!!.itemView.top + mSwipeRightPadding[0] + mSwipeRightBackgroundMargin[1],
                            viewHolder!!.itemView.left + dX.toInt() + mSwipeRightBackgroundMargin[2],
                            viewHolder!!.itemView.bottom - mSwipeRightPadding[2] + mSwipeRightBackgroundMargin[3]
                        )
                ...
                if (swipeRightActionIconId != 0 && dX > iconHorizontalMargin) {
                    val icon = ContextCompat.getDrawable(
                        recyclerView!!.context, swipeRightActionIconId
                    )
                    if (icon != null) {
                ...
                // Swiping Left
                canvas!!.clipRect(
                    viewHolder!!.itemView.right + dX.toInt() + mSwipeLeftBackgroundMargin[0],
                    viewHolder!!.itemView.top + mSwipeLeftBackgroundMargin[1],
                    viewHolder!!.itemView.right + mSwipeLeftBackgroundMargin[2],
                    viewHolder!!.itemView.bottom + mSwipeLeftBackgroundMargin[3]
                )
                if (swipeLeftBackgroundColor != 0) {
                    if (mSwipeLeftCornerRadius != 0f) {
                        ...
                        background.setBounds(
                            viewHolder!!.itemView.right + dX.toInt() + mSwipeLeftBackgroundMargin[0],
                            viewHolder!!.itemView.top + mSwipeLeftPadding[0] + mSwipeLeftBackgroundMargin[1],
                            viewHolder!!.itemView.right - mSwipeLeftPadding[1] + mSwipeLeftBackgroundMargin[2],
                            viewHolder!!.itemView.bottom - mSwipeLeftPadding[2] + mSwipeLeftBackgroundMargin[3]
                        )
                        background.cornerRadii = floatArrayOf(
                            mSwipeLeftCornerRadius,
                            mSwipeLeftCornerRadius,
                        ...
                        background.setBounds(
                            viewHolder!!.itemView.right + dX.toInt() + mSwipeLeftBackgroundMargin[0],
                            viewHolder!!.itemView.top + mSwipeLeftPadding[0] + mSwipeLeftBackgroundMargin[2],
                            viewHolder!!.itemView.right - mSwipeLeftPadding[1] + mSwipeLeftBackgroundMargin[2],
                            viewHolder!!.itemView.bottom - mSwipeLeftPadding[2] + mSwipeLeftBackgroundMargin[3]
                        )
                        background.draw(canvas!!)
    ...
    class Builder(
        ...
        /**
         * Set the margin of the background in the given unit (default is 0dp)
         * @param unit @TypedValue the unit to convert from
         * @param left the left margin value
         * @param top the top margin value
         * @param right the right margin value
         ...
         * @return This instance of @RecyclerViewSwipeDecorator.Builder
         */
        fun setSwipeLeftBackgroundMargin(unit: Int, left: Float, top: Float, right: Float, bottom: Float): Builder {
            mDecorator.setSwipeLeftBackgroundMargin(unit, left, top, right, bottom)
            return this
        }
         ...
         * @return This instance of @RecyclerViewSwipeDecorator.Builder
         */
        fun setSwipeRightBackgroundMargin(unit: Int, left: Float, top: Float, right: Float, bottom: Float): Builder {
            mDecorator.setSwipeRightBackgroundMargin(unit, left, top, right, bottom)
            return this
        }
